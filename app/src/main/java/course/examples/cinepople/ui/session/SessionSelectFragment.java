...
//
//import course.examples.cinepople.adapter.CinemaSessionAdapter;
//import course.examples.cinepople.adapter.DateAdapter;
//import course.examples.cinepople.data.CinemaSession;
//import course.examples.cinepople.data.DateModel;
...
//        dateList.clear();
//        dateList.add(new DateModel("Today", "Oct 5", true)); // true = được chọn
//        dateList.add(new DateModel("Mon", "Oct 6", false));
//        dateList.add(new DateModel("Tue", "Oct 7", false));
//        dateList.add(new DateModel("Wed", "Oct 8", false));
//        dateList.add(new DateModel("Thu", "Oct 9", false));
